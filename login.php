        	...
        	<div class="content-box">
               ...
               echo $msg;
                ?>
                	<div class="lileft">
                        <label>Email</label>
                        <input type="text" name="txt1" style="border-color: #000000" required>
                    </div>
                    
					<div class="liright">
                        <label>Password</label>                    
                        <input type="password" style="border-color: #000000" name="txt2" required>
                    </div>
                        ...
                        <a href="forgetpass.php">ForgotPassword?</a>
                        <div class="clear"></div>
