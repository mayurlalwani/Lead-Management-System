...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    if ($_POST) 
        ...
        $oq = mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin where admin_name =  '{$loginid}'  ") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
        ...
        if ($opass == $odata[1]) 
            {
                mysqli_query($GLOBALS["___mysqli_ston"], "update admin set admin_pass = '{$npass}' where admin_name= '{$loginid}'");
