...
<!--    <img src="proimg/logo.png"  style="margin-left: -30px;" width="150" >    -->
        ...
        <form method="post">
            ...
            <select name="bname">
                ...
                $qb = mysqli_query($GLOBALS["___mysqli_ston"], "select * from registration where atype ='Buyer'");
                while($edata = mysqli_fetch_row($qb))
                {
                    
                    echo "<option value='$edata[0]'> $edata[5]</option> ";
                }
                   ?>
                <input type="submit">
                </select>
...
where  `registration`.`uid`  = {$_POST['bname']}
";
