...
<input type="image" src="http://www.paypalobjects.com/en_US/i/btn/btn_buynow_LG.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!"/>
    ...
    <p style="text-align:center; font-weight:bold; padding-top:5mm;"><h2><center>INVOICE</center></h2></p>
		...
		<h1 class="heading">FTI Technologies PVT LTD</h1>
				<h2 class="heading">
					...
					Website : www.freelancetoindia.com<br>
					E-mail : info@freelancetoindia.com<br>
					Phone : +91-794-005-2446
				</h2>
			</td>
	...
	<div id="content">
		...
		<table style="width:100%; height:35mm;">
			<tbody><tr>
				...
				<div id="box">
					E &amp; O.E.<br>
					For FTI Technologies PVT LTD<br><br><br><br>
