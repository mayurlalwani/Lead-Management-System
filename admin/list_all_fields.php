	...
	for ( $i = 0; $i < $total_fields; $i++ )
        {
            echo "<tr>";
              ...
              $names[] = ((($___mysqli_tmp = mysqli_fetch_field_direct( mysqli_query($GLOBALS["___mysqli_ston"],  "SELECT * FROM $table_name"), $i)->name) && (!is_null($___mysqli_tmp))) ? $___mysqli_tmp : false);
                echo "<td>$i)<input type='checkbox' name='chk1[]' value='$names[$i]'>  $names[$i]</td>";
